...
\>\terminal{\# line}\>\>预处理符号群~换行\br
\>\terminal{\# error}\>\>预处理符号群\opt~换行\br
\>\terminal{\# pragma}\>\>预处理符号群\opt~换行\br
\>\terminal{\# }换行
\end{bnftab}
